...
class TestQuestionViews(TestCase):
    ...
    def test_get_a_question_wrong_id(self):
        ...
        url_2 = '/meetups/meetings/{}/questions/{}/'.format(resp_1.data['id'], 234)
        response = self.client.get(url_2)
    ...
    def test_editing_a_question_missing_title(self):
        ...
        url_2 = '/meetups/meetings/{}/questions/{}/'.format(resp_1.data['id'], resp_2.data['id'])
        response = self.client.put(url_2, content_type='application/json', data=json.dumps(self.question_missing_title))
        self.assertEqual(response.status_code, 400)
